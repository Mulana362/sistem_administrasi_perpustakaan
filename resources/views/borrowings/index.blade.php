...
<style>
    ...
    @media (max-width: 768px){
        .borrow-kpi-grid,
        .fine-kpi-grid{ grid-template-columns:repeat(1, minmax(0, 1fr)); }
    }
...
@php
    ...
    function renderBorrowPagination($paginator, $activeTab = 'pengajuan') {
    ...
    <div class="tab-menu-card">
        <div class="tab-menu-header">
            <div>
                ...
                <div class="small-muted">
                    Pengajuan, peminjaman aktif, keterlambatan, laporan denda, dan riwayat buku kembali.
                </div>
            </div>
        ...
        <div class="tab-content pb-3 px-2">
            ...
            <div class="tab-pane fade {{ $activeTab === 'aktif' ? 'show active' : '' }}" id="aktif" role="tabpanel">
                <div class="px-2 pb-3">
                    <div class="small-muted mb-2">Buku yang sedang dipinjam dan belum melewati jatuh tempo.</div>
                            ...
                            <tbody>
                                @forelse($aktif as $borrowing)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap gap-1">
                                                <a href="{{ route('borrowings.edit', ['borrowing' => $borrowing->id, 'active_tab' => 'aktif']) }}" class="btn btn-success btn-pill-sm">
                                                    Tandai Kembali
                                                </a>
                                            </div>
                                        </td>
                        ...
                        <table class="table table-report align-middle mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:140px;">Status</th>
                                    <th class="print-hide" style="width:220px;">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                            ...
                                            <div class="d-flex flex-wrap gap-1">
                                                @if(!$borrowing->fine_paid && ($borrowing->fine_amount ?? 0) > 0)
                                                    <form action="{{ route('borrowings.fine.paid', $borrowing->id) }}" method="POST"
                                                        ...
                                                        <button class="btn btn-warning btn-pill-sm">Konfirmasi Lunas</button>
                                                    </form>
                                                @elseif($borrowing->fine_paid)
                                                    <form action="{{ route('borrowings.fine.unpaid', $borrowing->id) }}" method="POST"
                                                        ...
                                                        <input type="hidden" name="fine_start" value="{{ $filterStart }}">
                                                        <input type="hidden" name="fine_end" value="{{ $filterEnd }}">
                                                        <button class="btn btn-outline-warning btn-pill-sm">Batalkan Lunas</button>
                                                    </form>
                                                @endif

                                                <a href="{{ route('borrowings.edit', ['borrowing' => $borrowing->id, 'active_tab' => 'terlambat']) }}" class="btn btn-success btn-pill-sm">
                                                    Tandai Kembali
                                                </a>
                                            </div>
                                        </td>
                                ...
                                @empty
                                    <tr><td colspan="12" class="text-center text-muted py-3">Belum ada data keterlambatan.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-report align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr><td colspan="12" class="text-center text-muted py-3">Belum ada data denda lunas.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-report align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr><td colspan="9" class="text-center text-muted py-3">Belum ada riwayat pengembalian.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
